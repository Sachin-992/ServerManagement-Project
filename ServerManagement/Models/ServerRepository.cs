...
{
    public static class ServersRepository          //The ServersRepository class is a static class that acts as an in-memory repository for storing, retrieving, and managing server data.
    {
